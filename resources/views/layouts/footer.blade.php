...
<footer id="footer" class="footer">
    <div class="copyright">
        &copy; Copyright <strong><span>ipsos</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
        ...
        <!-- Designed by <a href="https://bootstrapmade.com/">erza mazde</a> -->
    </div>
</footer><!-- End Footer -->
...
<script src="{{asset('templates')}}/assets/vendor/chart.js/chart.min.js"></script>
<script src="{{asset('templates')}}/assets/vendor/echarts/echarts.min.js"></script>
<script src="{{asset('templates')}}/assets/vendor/quill/quill.min.js"></script>
